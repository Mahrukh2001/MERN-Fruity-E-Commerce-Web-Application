              ...
              <Link to={""}>
                ...
                <div className="flex item-center gap-4 md:gap-7">
                    <nav className="gap-4 md:gap-6 text-base md:text-lg hidden md:flex">
                        ...
                        <Link to={""}>Home</Link>
                        <Link to={"menu/6527cc67897e535507f1d530"}>Menu</Link>
                    ...
                    <div className=" text-slate-600" onClick={handleShowMenu}>
                        <div className="text-3xl cursor-pointer w-full h-8 rounded-full overflow-hidden drop-shadow" >
                        ...
                        <div className="absolute right-2 bg-white py-2 shadow drop-shadow-md flex flex-col min-w-[120px] text-center">
                            ...
                            {
                                userData.email ? <p className="cursor-pointer text-white px-2 bg-blue-500" onClick = {handleLogout}>Logout ({userData.firstName})</p> : <Link to ={"login"} className="whitespace-nowrap cursor-pointer px-2">Login</Link>
                            }
                             <nav className="text-base md:text-lg flex flex-col md:hidden">

                               <Link to={""} className="px-2 py-1">Home</Link>
                               <Link to={"menu/6527cc67897e535507f1d530"} className="px-2 py-1" >Menu</Link>
